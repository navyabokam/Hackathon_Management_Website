    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <header className="bg-white shadow">
        <nav className="max-w-7xl mx-auto px-4 py-6 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <img src="/klu-logo.jpg" alt="KL University Logo" className="h-16 w-auto object-contain" />
            <img src="/gfg-logo.jpg" alt="GFG Logo" className="h-16 w-auto object-contain" />
          </div>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-4">
            <p className="text-blue-300 text-sm uppercase tracking-widest mb-2">Department of CSE Presents</p>
            <h1 className="text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-500 mb-3 pb-4 leading-tight">
              ForgeAscend v1.0
            </h1>
            <p className="text-xl text-gray-300 italic mb-8">From Concept to Code — Guided to Greatness</p>
          </div>
          ...
          <a
            href="/register"
            className="inline-block px-12 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white text-xl font-bold rounded-lg hover:from-blue-700 hover:to-cyan-700 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all"
          >
            Register Your Team
          </a>
          ...
          <div className="mt-16 flex flex-col items-center">
            <p className="text-gray-300 text-base uppercase tracking-widest mb-6">Sponsored By</p>
            <div className="bg-white/10 backdrop-blur-sm px-24 py-12 rounded-2xl border border-white/20 hover:border-white/40 transition-all min-w-[800px] max-w-5xl">
              <div className="flex items-center justify-center gap-12 flex-wrap">
                <img src="/gradStreet.jpg" alt="GradStreet" className="h-16 w-auto object-contain" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Prize Pool */}
          <div className="bg-gradient-to-br from-yellow-600/20 to-orange-600/20 backdrop-blur-md p-8 rounded-2xl border border-yellow-500/30">
            <div className="text-center mb-6">
              <div className="text-5xl mb-4">🏆</div>
              <h2 className="text-4xl font-black text-yellow-300 mb-2">₹50,000</h2>
              <p className="text-xl text-gray-300">Prize Pool</p>
            </div>
            <div className="grid grid-cols-4 gap-4 mt-6">
              <div className="text-center">
                <div className="w-16 h-16 mx-auto bg-gradient-to-br from-cyan-300 to-blue-400 rounded-full flex items-center justify-center text-3xl mb-2 shadow-lg">
                  💎
                </div>
                <p className="text-xs text-gray-300 mb-1">Platinum</p>
                <p className="text-sm font-bold text-cyan-300">₹20,000</p>
              </div>
              <div className="text-center">
          ...
          {/* Registration Fee */}
          <div className="bg-gradient-to-br from-blue-600/20 to-cyan-600/20 backdrop-blur-md p-8 rounded-2xl border border-blue-500/30">
            <h2 className="text-3xl font-bold text-white mb-6 text-center">Registration Fee</h2>
      ...
      {/* Features */}
      <section className="max-w-7xl mx-auto px-4 py-16">
        <h2 className="text-4xl font-bold text-white mb-10 text-center">What You Get</h2>
